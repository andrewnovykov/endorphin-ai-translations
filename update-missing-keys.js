	...
	if (fs.existsSync(filePath)) {
		try {
			...
			if (data.testStructurePage && data.testStructurePage.aiPoweredData) {
				data.testStructurePage.aiPoweredData.ecommerceProductTesting =
					translations[lang].ecommerceProductTesting;
				data.testStructurePage.aiPoweredData.complexBusinessScenarios =
					translations[lang].complexBusinessScenarios;
